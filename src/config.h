...
const unsigned char newReq11[8] = {0x2A, 0x1E, 0xE5, 0x00, 0x01, 0x21, 0x00, 0x00}; //2 bytes of request = 74 bytes aka 0x4A
...
const unsigned int updateInt         = 1000;  // loop update interval in ms (40 = ~10hz, 10 = ~25hz)
